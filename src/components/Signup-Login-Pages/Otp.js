            ...
            <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                    ...
                    <div variant="body2" className='d-flex alignItems-start justify-content-between'>
                        ...
                        <span className='text-primary' style={{ cursor: 'pointer' }}>Resend OTP</span>
                    </div>

                    <Button fullWidth style={{ backgroundColor: "#F6F8FB", color: "black" }} className='my-3 fw-bold' type="submit" // Change to submit
