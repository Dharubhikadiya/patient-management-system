...
const data = [
  ...
  { name: 'New Patients', value: 100, color: '#3B82F6' },  // Orange
];
...
export default function PatientsBreakdown() {
  return (
    <div className='bg-white p-2 rounded-lg' style={{ width: "100%", height:"300px"}}>
    <h3 className='text-xl font-bold p-2 d-flex'>Patients Summary</h3>
