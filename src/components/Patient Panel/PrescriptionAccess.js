...
import { MdAddPhotoAlternate, MdRemoveRedEye } from "react-icons/md";
                    ...
                    <div className='bg-white p-3 overflow'>
                        ...
                        <div>
                            <div className='d-flex justify-between'>
                                <h5 className='text-semibold mt-1'>Prescription Access</h5>
                            ...
                            <div className="gap-4 h-50 mt-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div className="card border" style={{ maxWidth: '18rem' }}>
                                    <div className="py-2 px-2 fw-semibold flex items-center justify-between text-md bg-[#F6F8FB]">
                                        <span>Dr. Ryan Vectrovs</span>
                                        <div className='flex'>
                                            <div className='bg-[#DFF0F9] text-[#0EABEB] p-1 rounded-lg border-1 bg-white' onClick={toggleDetails}><PiDownloadFill className='mt-1 mx-1' /></div>
                                    ...
                                    <div className="card-body px-2 py-1 flex justify-between">
                                        ...
                                        <p className="mb-0 text-[#4F4F4F] fw-semibold">Artemis Hospital</p>
                                    </div>
                                    ...
                                    <div className="card-body px-2 py-0 flex justify-between">
                                        <p className="mb-0 text-[#818194]">Date</p>
                                        <p className="mb-0 text-[#4F4F4F] fw-semibold">2 jan, 2022</p>
                                    </div>
                                    <div className="card-body px-2 py-0 flex justify-between">
                                        <p className="mb-0 text-[#818194]">Time</p>
                                        <p className="mb-0 text-[#4F4F4F] fw-semibold">10:10 AM</p>
                                    </div>
                                    <div className="card-body px-2 py-1 mt-2 flex justify-start border m-2 rounded-lg">
                                       <span className='bg-[#F6F8FB] p-1 rounded-lg px-2 flex items-center justify-center'><MdAddPhotoAlternate className='text-[#5678E9] fs-4'/></span>
                                       <div className='ps-2'>
                                           <span className='mb-0 text-sm fw-semibold'>Prescription.JPG</span>
                                           <p className='mb-0 text-xs'>5.09 MB</p>
                                       </div>
                                    </div>
                                </div>
                                <div className="card border" style={{ maxWidth: '18rem' }}>
